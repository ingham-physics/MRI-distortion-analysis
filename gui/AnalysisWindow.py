...
class AnalysisWindow:
    ...
    def analyse(self):
        ...
        if not os.path.isfile(self.csv_file.get()):
            messagebox.showerror("Error", "Registration CSV file not found")
            return

        # Validate input Deformation file
        if not os.path.isfile(self.def_file.get()):
            messagebox.showerror("Error", "Deformation file not found")
            return
        ...
        try:
            ...
            messagebox.showerror("Error", "Ensure ISO Center is entered correctly")
            return
