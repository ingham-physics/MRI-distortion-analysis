...
# Runs reorientation
def mrl_deformable(source_file, target_file, output_path, grid_spacing=5):
    ...
    subprocess.call(["milxDumpDeformationField", file_disp, ">", file_total])
    ...
    subprocess.call(["milxImageOperations", "-t", file_result, "100", file_mask])
    ...
    subprocess.call(["milxDumpDeformationField", file_masked_df, file_mask, ">", file_masked_csv])
